...
<html lang="en">
  ...
  <body>
    ...
    <section class="sec-one-blogaq">
      <div class="container">
        <h2 class="h-blog">ADVENTURE QUEST 3D MMORPG BLOG</h2>

        <div class="vid">
          <div class="row">
            <div class="vd col-sm-0 col-md-0">
              <iframe
                src="https://www.youtube.com/embed/AmKoxpir4_E"
                title="AQ3D  Samurai class"
                frameborder="0"
          ...
          <div class="row">
            <div class="vd col-sm-0 col-md-0">
              <iframe
                width="713"
                height="401"
                src="https://www.youtube.com/embed/rTPS8npbQeU?list=PLuXu1OfZRezb7W6BCT2anm1c70SE3lusW"
                title="Adventure quest 3D Mmorpg | create char and costum"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen
              ></iframe>
